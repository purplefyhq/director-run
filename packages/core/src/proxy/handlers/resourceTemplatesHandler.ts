...
import { ListResourceTemplatesRequestSchema, ListResourceTemplatesResultSchema } from "@modelcontextprotocol/sdk/types.js";
import type { ResourceTemplate } from "@modelcontextprotocol/sdk/types.js";
import type { ConnectedClient } from "../createClients";

export function setupResourceTemplateHandlers(server: Server, connectedClients: ConnectedClient[]) {
