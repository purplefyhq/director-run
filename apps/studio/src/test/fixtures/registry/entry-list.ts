...
export const mockRegistryEntryList: RegistryEntryList = [
      ...
      "parameters": [
        {
          ...
          "type": "string",
          "required": true,
          "description": "The path to the directory to allow filesystem operations in."
        }
      ],
      "icon": "https://registry.director.run/mcp.svg",
      "state": "published"
      ...
      "parameters": [
        {
          ...
          "password": true,
          "required": true,
          "description": "Get a personal access token from [GitHub Settings](https://github.com/settings/tokens)"
        }
      ],
    ...
    },
    {
      ...
      "name": "notion",
      "title": "Notion",
      "description": "Connect to Notion API, enabling advanced automation and interaction capabilities for developers and tools.",
      "transport": {
        "env": {
          "OPENAPI_MCP_HEADERS": "{\"Authorization\": \"Bearer <notion-bearer-token>\", \"Notion-Version\": \"2022-06-28\" }"
        },
        "args": [
          "-y",
      ...
      "parameters": [
        {
          ...
          "password": true,
          "required": true,
          "description": "Get a bearer token from [Notion Settings](https://www.notion.so/profile/integrations)"
        }
      ],
    ...
    },
    {
      ...
      "parameters": [
        ...
        },
        {
          ...
          "type": "string",
          "required": true,
          "description": "Channel IDs, comma separated. (e.g. 'C01234567, C76543210')"
        }
      ],
