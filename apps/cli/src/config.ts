...
import { createEnv, isProduction } from "@director.run/utilities/env";
import { z } from "zod";
...
export const env = createEnv({
  ...
  envVars: {
    ...
    GATEWAY_URL: z.string().optional().default(`http://localhost:${3673}/trpc`),
    DATA_DIR: z.string().optional().default(getDataDir()),
    DB_FILE_PATH: z
      .string()
      .optional()
