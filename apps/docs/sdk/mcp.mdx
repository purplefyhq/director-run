...
The Director MCP API provides a simple interface for creating MCP servers, proxies and clients. It extends the official [Typescript SDK](https://github.com/modelcontextprotocol/typescript-sdk). The source code is available in [packages/mcp](https://github.com/theworkingcompany/director/tree/main/packages/mcp).
