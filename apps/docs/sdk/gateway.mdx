...
The Gateway API allows you to start and manage a director instance programmatically. The source code is available in [packages/gateway](https://github.com/theworkingcompany/director/tree/main/packages/gateway).
