  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "z-50 w-fit text-balance rounded-sm bg-gray-12 px-3 py-1.5 text-gray-1 text-xs",
          "fade-in-0 zoom-in-95 origin-(--radix-tooltip-content-transform-origin) animate-in",
